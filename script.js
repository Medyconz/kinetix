(() => {
  ...
  function enhanceFooter() {
    ...
    contact.innerHTML = '<a href="https://wa.me/000000000000" target="_blank" rel="noreferrer">WhatsApp</a><a href="https://instagram.com/kinetix" target="_blank" rel="noreferrer">Instagram</a><a href="https://www.tiktok.com/@kinetix" target="_blank" rel="noreferrer">TikTok</a><a href="mailto:hello@kinetix.example">Email</a>';
  ...
  function bindRevealMotion() {
    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach((entry) => {
        ...
        reveal(entry.target, Array.from(targets).indexOf(entry.target));
